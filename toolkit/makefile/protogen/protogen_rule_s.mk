#  ======================================================================================
#  File         : protogen_rule_s.mk
#  Author       : Wu Jie 
#  Last Change  : 03/20/2012 | 20:03:35 PM | Tuesday,March
#  Description  : 
#  ======================================================================================
...
GenObjs := $(patsubst %.proto,%.cs,$(FullPath_Srcs))
...
$(GenDir)/%.cs: %.proto
	...
	$(CC) $(CFlags) -i:$< -o:$@ 2>>$(ErrDir)/$(ErrLogName) 
